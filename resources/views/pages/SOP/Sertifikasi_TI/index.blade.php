...
<x-breadcrumb :values="[__('Sertifikasi Dan TI'), __('SOP')]">
    <a href="{{ route('SOP.Sertifikasi_TI.create') }}" class="btn btn-primary">{{ __('menu.general.create') }}</a>
</x-breadcrumb>
                        ...
                        <button class="btn p-0" type="button" id="dropdown-{{ $sop->type }}-{{ $sop->id }}"
                            ...
                            <div class="dropdown-menu dropdown-menu-end"
                                ...
                                <a class="dropdown-item"
                                   href="{{ route('SOP.Sertifikasi_TI.edit', $sop->id) }}">{{ __('menu.general.edit') }}</a>
