...
<x-breadcrumb :values="[__('Administrasi Dan Keuangan'), __('SOP')]">
    <a href="{{ route('SOP.Administrasi_Keuangan.create') }}" class="btn btn-primary">{{ __('menu.general.create') }}</a>
</x-breadcrumb>
                        ...
                        <button class="btn p-0" type="button" id="dropdown-{{ $sop->type }}-{{ $sop->id }}"
                            ...
                            <div class="dropdown-menu dropdown-menu-end"
                                ...
                                <a class="dropdown-item"
                                   href="{{ route('SOP.Administrasi_Keuangan.edit', $sop->id) }}">{{ __('menu.general.edit') }}</a>
