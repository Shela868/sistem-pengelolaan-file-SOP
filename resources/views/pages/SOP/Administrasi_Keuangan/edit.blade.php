...
@section('content')
    <div class="breadcrumb">
        {{ __('SOP') }} / {{ __('Adminitrasi_Keuangan') }}
    </div>

    <div class="card mb-4">
        <form action="{{ route('SOP.Administrasi_Keuangan.update', ['Administrasi_Keuangan' => $data->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
