...
class Manajemen_MutuController extends Controller
{
    /**
    ...
    {
        return view('pages.SOP.Manajemen_Mutu.create', [
            'sop' => SOP::all(),
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()
                ->route('SOP.Manajemen_Mutu.index')
    ...
    {
        return view('pages.SOP.Manajemen_Mutu.edit', [
            'data' => SOP::find($id),
            'classifications' => Classification::all(),
            'statuses' => LetterStatus::all(),
        ]);
