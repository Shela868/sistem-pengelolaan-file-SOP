...
class OutputSertifikasi_TIController extends Controller
{
    /**
    ...
    {
        $outputQuery = output_sop::where('klasifikasi', 'SRTI');
        ...
        return view('pages.Output.Sertifikasi_TI.index', [
            'output' => $output,
    ...
    {
        return view('pages.Output.Sertifikasi_TI.create', [
            'sop' => output_sop::all(),
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()
                ->route('Output.Sertifikasi_TI.index')
    ...
    {
        return view('pages.Output.Sertifikasi_TI.edit', [
