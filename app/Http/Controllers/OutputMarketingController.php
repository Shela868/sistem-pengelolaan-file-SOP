...
class OutputMarketingController extends Controller
{
    /**
    ...
    {
        $outputQuery = output_sop::where('klasifikasi', 'MRK');
        ...
        return view('pages.Output.Marketing.index', [
            'output' => $output,
    ...
    {
        return view('pages.Output.Marketing.create', [
            'sop' => output_sop::all(),
    ...
    {
        return view('pages.Output.Marketing.edit', [
