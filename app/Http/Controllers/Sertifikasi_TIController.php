...
class Sertifikasi_TIController extends Controller
{
    /**
    ...
    {
        $data = SOP::where('klasifikasi', 'SRTI');
        ...
        return view('pages.SOP.Sertifikasi_TI.index', [
            'data' => $data,
    ...
    {
        return view('pages.SOP.Sertifikasi_TI.create', [
            'sop' => SOP::all(),
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()
                ->route('SOP.Sertifikasi_TI.index')
    ...
    {
        return view('pages.SOP.Sertifikasi_TI.edit', [
            'data' => SOP::find($id),
            'classifications' => Classification::all(),
            'statuses' => LetterStatus::all(),
        ]);
