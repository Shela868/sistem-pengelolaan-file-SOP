...
class MarketingController extends Controller
{
    ...
    {
        return view('pages.SOP.Marketing.create', [
            'sop' => SOP::all(),
    ...
    {
        return view('pages.SOP.Marketing.edit', [
            'data' => SOP::find($id),
            'classifications' => Classification::all(),
            'statuses' => LetterStatus::all(),
        ]);
